...
class RelationSet:
    ...
    def add(self, relation):
        ...
        print('Sentence: TODO')
        print('RelationType: %s | Confidence= %s | EntityType1= %s | EntityValue1= %s | EntityType2= %s | EntityValue2= %s' % (self.relation_type, new_confidence, self.entity_type_1, entity_value_2, self.entity_type_2, entity_value_2))
